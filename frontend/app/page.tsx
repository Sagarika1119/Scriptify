    ...
    <div className="flex h-screen bg-[#0a0a0a] text-[#ededed]">
      ...
      <aside className="w-64 bg-[#171717] flex flex-col justify-between p-4">
          ...
          <nav className="space-y-2">
            ...
            <div className="mt-6">
              ...
              <ul className="space-y-1">
                <li className={`rounded px-3 py-2 ${selectedPanel === "home" ? "bg-[#232323]" : "hover:bg-[#232323]/60"}`} onClick={() => setSelectedPanel("home")}>Home</li>
            ...
            <div className="mt-6">
              <div className="text-xs text-gray-400 uppercase mb-2">Explore Replit</div>
              <ul className="space-y-1">
                <li className="hover:bg-[#232323]/60 rounded px-3 py-2">Bounties</li>
                <li className={`rounded px-3 py-2 ${selectedPanel === "templates" ? "bg-[#232323]" : "hover:bg-[#232323]/60"}`} onClick={() => setSelectedPanel("templates")}>Templates</li>
        ...
        <div className="mt-8 border-t border-[#232323] pt-4">
          ...
          <button className="w-full py-2 bg-blue-900 text-blue-300 rounded hover:bg-blue-800 text-xs font-semibold">Upgrade to Replit Core</button>
        </div>
      </aside>
      {/* Main Content */}
        ...
        {selectedPanel === "create-app" ? (
          ...
          <div className="max-w-xl w-full">
            ...
            <div className="bg-[#171717] border border-[#232323] rounded p-4 text-xs text-gray-400 flex items-center justify-between">
              <span>Purchase domains on Replit</span>
